...
//    public boolean set(String smsKey, String smsRandomCode, long is, Enum Time) {
//        try {
//            redisTemplate.opsForValue().set(smsKey, smsRandomCode);
//            return true;
//        } catch (Exception e) {
//            e.printStackTrace();
//            return false;
...
//        }
//    }
    public boolean set(String smsKey, String smsRandomCode, long time, TimeUnit seconds) {
        try {
            if (time > 0) {
                redisTemplate.opsForValue().set(smsKey, smsRandomCode, time, seconds);
            } else {
